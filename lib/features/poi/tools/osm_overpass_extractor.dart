...
class OsmOverpassExtractor {
  ...
  OsmOverpassExtractor({LiveApiGuards? guards})
  ...
  Future<Map<String, dynamic>> fetchOverpass(
    ...
    if (response.statusCode != 200) {
      final snippet = response.body.length > 200
          ...
          : response.body;
      throw OverpassException('HTTP ${response.statusCode}: $snippet');
    }
  ...
  OsmExtractionResult extractFromResponse(
    ...
    for (final element in elements) {
      ...
      poiList.add(<String, dynamic>{
        ...
        'zone_name':
            tags['addr:district'] as String? ?? tags['addr:suburb'] as String?,
        'official_url':
    ...
    final fixture = <String, dynamic>{
      '_comment':
          'Generated by OsmOverpassExtractor from OpenStreetMap. '
