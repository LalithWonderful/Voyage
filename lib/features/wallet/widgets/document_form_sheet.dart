        ...
        try {
          ...
          if (diff != null && diff.hasChanges) {
            ...
            if (apply) {
              ...
              // V8 (2026-05-10) — applyTimelineDiff supprime les
              // activités générées par Lunao (cf.
              // `deleteGeneratedActivitiesForTrip` dans
              // activity_staleness_service.dart). On invalide le
              // provider pour rafraîchir le planning.
